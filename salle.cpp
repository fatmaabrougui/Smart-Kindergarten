...
void salle :: pdf_salle (QString fonction)
{
    QPdfWriter pdf("C:/Users/Lenovo/Documents/guinga/fatma+nour+yessine+louay/telecome/pdf_salle/alone3.pdf");/*il faut toujour changer le nom (*/
    ...
    QSqlQuery query;
     qWarning("testpdf1");
    query.exec("SELECT id_salle,fonction,capacite FROM salle WHERE fonction='"+fonction+"'");
      qWarning("testpdf2");
...
void salle :: impression_salle (QString fonction)
{
