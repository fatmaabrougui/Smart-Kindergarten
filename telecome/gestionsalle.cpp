...
gestionSalle::gestionSalle(QWidget *parent) : QDialog(parent)
...
{
    salle * s;
   s->pdf_salle(ui->pdf_fonction->text());
...
void gestionSalle::on_makePlot_released()
{
   ...
   int panne=m->calcul_panne();
   int n_panne=m->calcul_betat();
...
void gestionSalle::on_impri_salle_released()
{
   ...
   /* salle * s;
    ui->imprimer_edit->setModel(s->rechercher(ui->pdf_fonction->text()));
...

{
    ...
    materiel * m;
   int total_panne= m->alert();
    QMessageBox::information(this, tr("Modifier Materiel"), tr(" before boucle test"));
    if (total_panne<3)

 {
    QMessageBox::information(this, tr("Modifier Materiel"), tr("boucle test"));
...
void gestionSalle::on_toy_clicked()
{
...
void gestionSalle::on_departement_clicked()
{
...
void gestionSalle::on_kid_clicked()
{
...
void gestionSalle::on_food_clicked()
{
...
void gestionSalle::on_welcome_clicked()
{
...
void gestionSalle::on_event_clicked()
{
