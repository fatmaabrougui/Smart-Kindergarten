...
class gestionjouets : public QDialog
{
    Q_OBJECT
...
private slots:
    void on_pb_ajouterEspace_released();

    bool on_pb_chercherS_released();

    void on_pb_confirmerEspace_released();
    ...
    void on_pb_trierEspace_released();
 ...
 //  void on_pb_trierJouets_released();

   void on_pb_trierJouets_clicked();

   void on_afficher_stat2_clicked();

   void on_afficher_stat2_2_clicked();
