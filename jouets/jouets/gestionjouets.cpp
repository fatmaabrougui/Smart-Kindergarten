...
void gestionjouets::on_mail_released()
{
    ...
    s->sendMail("fournisseurX@gmail.com",ui->lineEdit_distinataire->text(),ui->lineEdit_sujetmail->text(),ui->lineEdit_2_text_mail->text());
...
void gestionjouets::on_pb_ajouterEspace_released()
{
    ...
    QString fonction_espace= ui->fonctionAdd->text();
     ...
     int id_espace = ui->idAddEspace->text().toInt();
...
{
    QPdfWriter pdf("C:/Users/LENOVO/Desktop/jouets/pdf/zzz.pdf");/*il faut toujour changer le nom (*/
    QPainter painter;
